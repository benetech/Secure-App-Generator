...
import org.martus.android.vitalVoices.adapters.AttachmentAdapter;
import org.martus.android.vitalVoices.adapters.AttachmentAdapterItemClickListener;
...
public class ManageAttachmentsActivty extends ListActivity implements AttachmentAdapterItemClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void copyFileToDir(SecureFile fileToCopy, SecureFile parentDir) {
        try {
            ...
            Log.e(TAG, "Could not copy image file to gallary", e);
        }
    }
    ...
    public void onDeleteRequested(String attachmentFileName) {
        ...
        Toast.makeText(this, "Could not delete attachment = " + attachmentFileName, Toast.LENGTH_SHORT).show();
    }
