package org.martus.android.vitalVoices.utilities;
...
public class Utility {
    ...
    public static String ioCipherFileToString(SecureFile file) throws Exception {
        StringBuilder instanceFormStringBuilder = new StringBuilder();
        int characterRead;
        SecureFileInputStream fileInputStream = new SecureFileInputStream(file);
        while((characterRead = fileInputStream.read()) != -1){
            instanceFormStringBuilder.append((char) characterRead);
        }

        return instanceFormStringBuilder.toString();
    }
