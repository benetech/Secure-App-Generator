...
import org.martus.android.vitalVoices.collect.tasks.SecureSavePointTask;
import org.martus.android.vitalVoices.collect.tasks.SecureSaveToDiskTask;
 ...
 * that uses {@link org.martus.android.vitalVoices.collect.io.SecureFileStorageManager} for secure
 * File I/O.
...
public class MainFormEntryActivity extends FormEntryActivity implements ICacheWordSubscriber, MartusUploadManager.MartusUploadManagerCallback {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_form_entry);
        mQuestionHolder = (android.widget.LinearLayout) findViewById(R.id.questionholder);
	}
     ...
     *
     * Our Vital Voices app flow has the user shuttling between {@link org.martus.android.vitalVoices.activities.FormGroupActivity}
     ...
     * re-loading the entire form definition every time you select a group to edit from {@link org.martus.android.vitalVoices.activities.FormGroupActivity}
     */
    @Override
    ...
    /**
     * Unlike the super implementation, return to {@link org.martus.android.vitalVoices.activities.MainActivity}
    ...
    public void savingComplete(SaveResult saveResult) {
        ...
        if (saveStatus == SaveToDiskTask.SAVED_AND_EXIT) {
            ...
            Toast.makeText(this, getString(org.odk.collect.android.R.string.data_saved_ok),
