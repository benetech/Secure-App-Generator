package org.martus.android.vitalVoices.adapters;
...
public class FormAdapter extends SimpleCursorAdapter {
    ...
    public FormAdapter(Context context, Cursor c, FormAdapterItemClickListener listener) {
        super(context, R.layout.form_list_item, c, new String[]{} , new int[]{}, 0);
        mListener = listener;
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (viewCache == null) {
            ...
            viewCache.syncButton = (ImageButton) view.findViewById(R.id.syncButton);
            viewCache.deleteButton = (ImageButton) view.findViewById(R.id.deleteButton);
            viewCache.manageAttachmentsButton = (ImageButton) view.findViewById(R.id.manageAttachmentsButton);
        ...
        view.setTag(R.id.tag_view_cache_object_id, cursor.getInt(viewCache.id_col));
	...
	private static Cursor getFormForView(View button) {
		int id = (Integer) ((View) button.getParent()).getTag(R.id.tag_view_cache_object_id);
