...
import org.martus.android.vitalVoices.collect.tasks.SecureFormLoaderTask;
...
import org.martus.android.vitalVoices.utilities.OdkFormInstanceValidator;
import org.martus.android.vitalVoices.utilities.Utility;
import org.martus.android.vitalVoices.FormFromAssetFolderExtractor;
import org.martus.android.vitalVoices.MartusUploadManager;
import org.martus.android.vitalVoices.R;
import org.martus.android.vitalVoices.application.AppConfig;
import org.martus.android.vitalVoices.application.MainApplication;
import org.martus.android.vitalVoices.clientside.SecureMobileAttachmentProxy;
import org.martus.android.vitalVoices.tasks.UploadBulletinTask;
import org.martus.android.vitalVoices.tasks.ZipBulletinTask;
import org.martus.android.vitalVoices.clientside.SecureMobileClientBulletinStore;
...
public class BulletinActivity extends SherlockFragmentActivity implements BulletinSender, IndeterminateProgressDialog.IndeterminateProgressDialogListener,
    ...
    private void addXFormsElement(Bulletin bulletin) throws Exception {
        ...
        if (formInstance == null)
            throw new RuntimeException("Failed to load form model or form instance");
    ...
    public void onZipped(Bulletin bulletin, File zippedFile) {
        try {
            ...
            Log.e(TAG, "Error verifying zip file", e);
            indeterminateDialog.dismissAllowingStateLoss();
    ...
    private void deleteFormAfterSent() {
        ...
        if (wasDeleted)
            Log.i(TAG, "Form was deleted after upload was completed");
        else
            Log.i(TAG, "Form could not be deleted");
    ...
    private MartusSecurity cloneSecurity(MartusSecurity original) {
        ...
        try {
            ...
            Log.e(TAG, "Problem copying crypto", e);
        }
        return cryptoCopy;
    }
    ...
    public String getIndeterminateDialogMessage() {
        return "Preparing record for upload";
    }

    @Override
    public String getDeterminateDialogMessage() {
        return "Uploading record...";
    }
    ...
    public void loadingComplete(FormLoaderTask task) {
        try {
            ...
            handleException(e, R.string.xforms_constraint_error, "XForms constraint issues found during validation process");
        } catch (XFormsMissingRequiredFieldException e) {
            handleException(e, R.string.xforms_missing_required_field, "XForms required fields missing");
        } catch (Exception e){
            handleException(e, R.string.failure_zipping_bulletin, "Exception thrown trying to populate record");
            Log.e(TAG, "Exception thrown trying to populate record", e);
        }
    }
    ...
    private String getXFormsInstanceContent(Context context) throws Exception{
        ...
        try {
            ...
            Log.e(TAG, "Error reading file path:"  + formInstancePath, e);
            return null;
        }
    }
    ...
    private void addAttachmentsToBulletin(Bulletin bulletin) throws Exception
    {
        ...
        for (SecureFile attachmentFile : attachmentFiles)
        {
            ...
            if (attachmentFile.exists())
                ...
                throw new Exception("File to attach does not exist: " + attachmentFile);
        }
    }
