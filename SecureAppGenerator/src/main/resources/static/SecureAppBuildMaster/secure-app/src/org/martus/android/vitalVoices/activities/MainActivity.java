...
import org.martus.android.vitalVoices.adapters.FormAdapter;
import org.martus.android.vitalVoices.adapters.FormAdapter.FormAdapterItemClickListener;
...
public class MainActivity extends ListActivity implements ICacheWordSubscriber, FormAdapterItemClickListener, LoaderCallbacks<Cursor>, MartusUploadManager.MartusUploadManagerCallback {
    ...
    private void extractFormFromAssetFolderToSecureStorage() {
        ...
        try {
            ...
            Log.e(TAG, "Copying form from assets folder to secure storage failed!", e);
        }
    }
