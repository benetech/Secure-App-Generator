...
import org.martus.android.vitalVoices.activities.BulletinActivity;
import org.martus.android.vitalVoices.activities.Util;
 ...
 * {@link #setMartusUploadCallback(org.martus.android.vitalVoices.MartusUploadManager.MartusUploadManagerCallback)}
 *
...
//                    showProgressDialog(getString(R.string.progress_confirming_upload_rights));
                ...
                Log.e(TAG, "problem processing server IP", e);
            }
        }
    };
...
//                editor.commit();
                ...
                Log.e(TAG, "Problem verifying upload rights", e);
